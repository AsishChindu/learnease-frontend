...
export default function MobileFooterNav() {
  return (
    <div className="fixed bottom-0 left-0 right-0 p-1 px-3 grid grid-cols-5 gap-4 border-t border-gray-100 bg-white shadow-3xl text-gray-400 z-10 md:hidden h-16 justify-between">
